    ...
    def __post_init__(self):
        if not self.checkpoint_path:
            name = (
                ...
                if self.variant == "vjepa2_1_vit_base_384"
                else (
...
class VJEPA2WorldVisualEncoder(nn.Module):
    ...
    def _build_models(self):
        ...
        if self.config.variant == "vjepa2_1_vit_base_384":
            encoder, predictor = backbones.vjepa2_1_vit_base_384(
                pretrained=False,
    ...
    def load_vjepa2_weights(self, checkpoint_path: str):
        ...
        if self.config.variant in {"vjepa2_1_vit_base_384", "vjepa2_1_vit_large_384"}:
        ...
        strict = self.config.variant in {"vjepa2_1_vit_base_384", "vjepa2_1_vit_large_384"}
        self.encoder.load_state_dict(encoder_state, strict=strict)
        self.predictor.load_state_dict(predictor_state, strict=strict)
